...
class LoginFormAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): PassportInterface
    {
        ...
        $request->getSession()->set(Security::LAST_USERNAME, $email); // sauvegarde le dernier email entré par l'utilisateur via la session
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        ...
        // For example:
        //return new RedirectResponse($this->urlGenerator->generate('some_route')); faire une redirection sur la page home
